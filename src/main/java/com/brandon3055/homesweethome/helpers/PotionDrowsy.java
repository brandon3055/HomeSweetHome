...
public class PotionDrowsy extends Potion {
    ...
    public PotionDrowsy(int liquidColorIn) {
        super(false, liquidColorIn);
        setBeneficial();
        setPotionName("hsh.effect.drowsy.name");
    }
    ...
    public void renderInventoryEffect(int x, int y, PotionEffect effect, Minecraft mc) {
        ResourceHelperBC.bindTexture(ResourceHelperBC.getResourceRAW("homesweethome:textures/gui/effect_drowsy.png"));
